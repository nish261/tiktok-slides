    ...
    for i, line in enumerate(lines):
        ...
        line_y = y + (i * line_spacing)
            ...
            try:
                ...
                if has_emoji:
                    print(f"PLAIN // Using Apple emoji extraction for: {line[:50]}...")
                ...
                try:
                    ...
                    print(f"PLAIN // Successfully rendered mixed text with pilmoji fallback: {line[:50]}...")
                    
                except Exception as e2:
                    print(f"PLAIN // Pilmoji fallback also failed: {e2}")
